  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved todo_item as @todo_item" do
        ...
        post :create, {:todo_item => { "title" => "invalid value" }}, valid_session
        assigns(:todo_item).should be_a_new(TodoItem)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested todo_item" do
        ...
        TodoItem.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => todo_item.to_param, :todo_item => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the todo_item as @todo_item" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TodoItem.any_instance.stub(:save).and_return(false)
        put :update, {:id => todo_item.to_param, :todo_item => { "title" => "invalid value" }}, valid_session
        assigns(:todo_item).should eq(todo_item)
      end
